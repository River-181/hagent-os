...
**작업**:
- `06_LLM위키/sources/01~05` 및 `05-paperclip-교육-아이디어-통합정리.md` 정독
...
**작업**:
- `01-bottom-up-academy-research-source.md`, `01-notebooklm-bottom-up-prompts.md`를 기준 문서로 채택
...
- `_research/`는 제거하고 `02_전략/04_research/` 하나만 리서치 정본으로 고정
