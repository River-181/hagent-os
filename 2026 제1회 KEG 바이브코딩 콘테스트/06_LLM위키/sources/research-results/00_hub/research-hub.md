...
- [[06_LLM위키/sources/research-results/00_hub/research-plan-eduswarm-v0]] — 이번 라운드 리서치 범위와 우선순위
- [[06_LLM위키/sources/research-results/00_hub/research-prompts-by-tool]] — `Gemini Deep Research`, `Perplexity`, `NotebookLM`, `X`용 프롬프트
- [[06_LLM위키/sources/research-results/00_hub/research-log]] — 수집 기록과 다음 액션
- [[06_LLM위키/sources/research-results/00_hub/research-folder-guide]] — `research-results` 내부 구조와 읽는 순서
